...
# kernel path: /mnt/fast/nobackup/users/jg02228/overlap-loss-experiments/torchinductor_jg02228/cn/ccnyqtbiaagfvinoyy3b6qsm4v3gbdqzmkrozqavm4nmqqvnn47n.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg7_1
        del buf8
    return (buf7, reinterpret_tensor(buf9, (s55, min(s14, s23), s87), (s87*min(s14, s23), s87, 1), 0), )
