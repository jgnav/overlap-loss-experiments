...
# kernel path: /mnt/fast/nobackup/users/jg02228/overlap-loss-experiments/torchinductor_jg02228/er/cersbnmnq5a7tvk4cp7g5jhlwiofpcqwxelexjb54dg72nlmcdf3.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg7_1
        del buf12
    return (buf11, reinterpret_tensor(buf13, (s55, min(s14, s23), s87), (s87*min(s14, s23), s87 // min(s14, s23), 1), 0), )
